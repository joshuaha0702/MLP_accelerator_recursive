...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_temp_ip is
  port (
    r_done_led_reg_0 : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_temp_ip is
  ...
  signal r_done_led_i_1_n_0 : STD_LOGIC;
  signal r_done_led_i_2_n_0 : STD_LOGIC;
  signal \^r_done_led_reg_0\ : STD_LOGIC;
  ...
  signal \r_y_buf_data[31]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \rcnt[31]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \r_y_buf_addr[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \r_y_buf_addr[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \r_y_buf_addr[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_y_buf_addr[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_y_buf_addr[6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \r_y_buf_addr[8]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \rcnt[10]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rcnt[11]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rcnt[12]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rcnt[13]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rcnt[14]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rcnt[15]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rcnt[16]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rcnt[17]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rcnt[18]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rcnt[19]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rcnt[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rcnt[20]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rcnt[21]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \rcnt[22]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \rcnt[23]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \rcnt[24]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \rcnt[25]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \rcnt[26]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \rcnt[27]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rcnt[28]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rcnt[29]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \rcnt[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rcnt[30]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \rcnt[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rcnt[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rcnt[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rcnt[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rcnt[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rcnt[8]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rcnt[9]_i_1\ : label is "soft_lutpair8";
begin
  E(0) <= \^e\(0);
  r_done_led_reg_0 <= \^r_done_led_reg_0\;
...
r_done_intr_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
r_done_intr_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
r_done_intr_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \^y_buf_data\(2),
      I2 => \^y_buf_data\(1),
      I3 => r_done_intr_i_4_n_0,
      I4 => r_done_intr_i_5_n_0,
      I5 => r_done_intr_i_6_n_0,
      O => r_done_intr_i_3_n_0
    );
r_done_intr_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => r_done_intr_i_7_n_0,
      I1 => \^y_buf_data\(23),
      I2 => \^y_buf_data\(22),
      I3 => \^y_buf_data\(25),
      I4 => \^y_buf_data\(24),
      I5 => r_done_intr_i_8_n_0,
...
r_done_intr_i_5: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \^y_buf_data\(7),
      I3 => \^y_buf_data\(6),
      I4 => r_done_intr_i_9_n_0,
      O => r_done_intr_i_5_n_0
    );
r_done_intr_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
r_done_intr_i_8: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFEFF"
    )
        port map (
...
r_done_led_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"22A000A0"
    )
        port map (
      I0 => rst_n,
      I1 => r_done_led_i_2_n_0,
      I2 => \^r_done_led_reg_0\,
      I3 => \^e\(0),
      I4 => r_done_intr_i_3_n_0,
      O => r_done_led_i_1_n_0
    );
r_done_led_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFEFFFF"
    )
        port map (
      I0 => r_done_intr_i_6_n_0,
      I1 => r_done_intr_i_5_n_0,
      I2 => r_done_intr_i_4_n_0,
      I3 => \^y_buf_data\(1),
      I4 => \^y_buf_data\(2),
      I5 => \^y_buf_data\(0),
      O => r_done_led_i_2_n_0
    );
r_done_led_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => r_done_led_i_1_n_0,
      Q => \^r_done_led_reg_0\,
      R => '0'
    );
...
\r_y_buf_addr[8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => r_done_led_i_2_n_0,
      I1 => \^e\(0),
      O => r_y_buf_addr
    );
...
\r_y_buf_data[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\rcnt[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
TEMP: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_temp_ip
     port map (
      ...
      r_done_led_reg_0 => r_done_led_reg,
      rst_n => rst_n,
      start_i => start_i,
      y_buf_addr(6 downto 0) => y_buf_addr(6 downto 0),
      y_buf_data(31 downto 0) => y_buf_data(31 downto 0)
