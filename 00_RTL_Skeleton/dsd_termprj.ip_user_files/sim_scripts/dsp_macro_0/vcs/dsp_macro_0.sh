...
design_libs=(xilinx_vip xpm xbip_dsp48_wrapper_v3_0_4 xbip_utils_v3_0_10 xbip_pipe_v3_0_6 dsp_macro_v1_0_3 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work dsp_macro_v1_0_3 $vhdlan_opts \
...
reset_run()
{
  files_to_remove=(ucli.key dsp_macro_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_macro_0_simv.daidir vcs_lib c.obj)
