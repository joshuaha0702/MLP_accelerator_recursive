...
#
# Script generated by Vivado on Sun Jun 15 20:01:23 +0900 2025
...
#
# Usage        : dsp_macro_0.sh
#                dsp_macro_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_macro_0.sh [-reset_run]
#                dsp_macro_0.sh [-reset_log]
#                dsp_macro_0.sh [-help]
#
...
#                script (type 'dsp_macro_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_utils_v3_0_10 -libname xbip_pipe_v3_0_6 -libname dsp_macro_v1_0_3 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xbip_dsp48_wrapper_v3_0_4 xbip_utils_v3_0_10 xbip_pipe_v3_0_6 dsp_macro_v1_0_3 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dsp_macro_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_macro_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work dsp_macro_v1_0_3 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_macro_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_macro_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_macro_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: dsp_macro_0.sh [-step]\n\
Usage: dsp_macro_0.sh [-lib_map_path]\n\
Usage: dsp_macro_0.sh [-reset_run]\n\
Usage: dsp_macro_0.sh [-reset_log]\n\
Usage: dsp_macro_0.sh [-keep_index]\n\
