...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_14 -L processing_system7_vip_v1_0_16 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dsp_macro_0 xil_defaultlib.dsp_macro_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_macro_0 -key {Behavioral:sim_1:Functional:dsp_macro_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_macro_0.wdb xsim.dir libdpi.so)
