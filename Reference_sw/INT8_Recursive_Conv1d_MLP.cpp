...
int main() {
    ...
    float layer1_scale = 0.1105961161335622;
    float layer2_scale = 0.0806436989251084;
    float layer3_scale = 0.1170919823834277;
    
    float weight_Conv1d_scale = 0.0058014801168066;
    float weight_Linear1_scale = 0.0071993188595209;
    float weight_Linear2_scale = 0.0059023203812246;
    float weight_Linear3_scale = 0.0039204441186950;
    ...
    */
    ...
    #if 0
    const char* filename = "./mnist_testset_txt_per_pixel/10_label_0.txt";
